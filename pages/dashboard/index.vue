<template>
  <div class="project-page">
    ...
    <section class="container mx-auto pt-8 mx-6">
      <div class="flex justify-between items-center mb-6">
        <div class="w-3/4 mr-6 px-6">
      ...
      <div class="block mb-2">
        ...
        -->
          <div
            class="w-full px-12 mt-8 border-b flex justify-between"
          >
            <div>
            ...
            <div>
              <button class="bg-teal-500 px-4 rounded-md text-gray-600">
                Detail
              </button>
            </div>
          </div>
